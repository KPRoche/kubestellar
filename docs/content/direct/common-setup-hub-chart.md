# Common Setup - hub chart

For more details please see [here](./hub-chart.md).
...
## Install KubeStellar Hub chart

A KubeStellar Hub installation compatible with the common setup suitable for Common Setup described in the [examples](https://docs.kubestellar.io/release-0.22.0/direct/examples/) could be achieved with the following command:
...
After the KubeStellar Hub has fully deployed, `kflex` CLI can be used to retrieve the kubeconfig of all the KubeFlex Control Planes and store them as contexts of the current kubeconfig:
