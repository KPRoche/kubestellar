...
This file includes the CONTRIBUTE.md file found in the root of the KubeStellar repository

---------------  start include --------------------

See also the [CONTRIBUTING]({{ config.repo_url }}/blob/{{ config.ks_branch }}/CONTRIBUTING) file for details.
