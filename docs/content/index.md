...
template: home.html
---
## Testing adding new content to the file ##
<!--kubestellar-->
<section class="main-background">
  <div class="md-grid conteiner-row pt-1 pt-lg-5 my-4">
    <div class="px-3 ctx-header-text conteiner">
          ...
          fetch(`https://api.github.com/repos/{{config.repo_short_name}}`)
            ...
            .then((data) => {
              ...
              if (typeof starCount !== 'undefined') {
                document.getElementById('star-count').setAttribute('hasInfo','true');
                document.getElementById('star-count').innerHTML = `<a href="https://github.com/kubestellar/kubestellar">${starCount}</a>`;
              }
              const forkCount = data.forks_count;
              if (typeof forkCount !== 'undefined') {
                document.getElementById('fork-count').setAttribute('hasInfo','true');
                document.getElementById('fork-count').innerHTML = `<a href="https://github.com/kubestellar/kubestellar">${forkCount}</a>`;
                // const releaseName = data.name;
                // document.getElementById('current-release').textContent = `${releaseName}`;
              }
            })
            .catch((error) => {
              console.error(error);
      ...
      <div class="conteiner-row conteiner-xs">
        ...
        <button
          type="button"
          title="{{ page.next_page.title | e }}"
          onclick="window.open('https://kubestellar.io/joinus', '_blank')"
    ...
    <div class="ctx-header-img d-xl">
      <img src="kubestellar-deploy.png" class="laverage-header-img" style="width:100%"" />
    </div>
  </div>
...
<section class="blue-background w-100">
      ...
      <div class="conteiner-row">      
        <div class="conteiner ctx-card-white-1 pt-4">
          ...
          <div class="d-sm text-align-center">
            <p class="display-4 Telegraf-UltraBold text-dark mx-auto mt-4">Create once</p>
            <p class="display-4 Telegraf-UltraBold text-blue mx-auto my-4">Deploy many</p>
          </div>
          ...
          <button
            onclick="window.open('https://github.com/kubestellar/kubestellar', '_blank')"
          ...
          <div class="text-dark h3 section-sm">
          </br></br>
            <ul>
              <li>- <b>Centrally</b> apply Kubernetes resources for selective deployment across multiple clusters</li>
            </br>          
              <li>- Use <b>standard Kubernetes-native deployment tools</b> (kubectl, Helm, Kustomize, ArgoCD, Flux); no resource bundling required</li>
            </br>
              <li>- <b>Discover</b> dynamically created objects created on remote clusters</li>
            </br>
              <li>- Make <b>disconnected</b> cluster operation possible</li>
            </br>
              <li>- <b>Scale</b> with 1:many and many:1 scenarios</li>
            </br>
              <li>- <b>Remain compatible</b> with cloud-native solutions</li>
            </br>
              <li>- Easy to install with <b>Helm</b> and <b>Brew</b></li>
            </ul>
          </div>
        </div>
...
<section class="blue-background w-100">
    <div class="md-grid conteiner-row pt-4 my-4">
        <div class="md:max-w-sm" style="color:black"><img style="max-width:300px" src="images/cncf-color.png" alt="Cloud Native Computing Foundation Logo">
        <p class="text-xs-center" style="color:black">We are a Cloud Native Computing Foundation sandbox project.</p>
        <p class="text-xs-center" style="color:black">Kubernetes and the Kubernetes logo are registered trademarks of The Linux Foundation® (TLF).</p>
        <p class="text-xs-center" style="color:black">© 2022-2024. The KubeStellar Authors.</p>
      </div>
    </div>
</section>
 ADDING MORE CONTENT 
